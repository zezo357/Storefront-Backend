...
describe('Dashboard Queries', function () {
    ...
    var DashboardQueriesObject = new dashboard_1.DashboardQueries();
    ...
    it("MostExpensiveProducts: should return ".concat(count, " most expensive products"), function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = expect;
                    return [4 /*yield*/, DashboardQueriesObject.MostExpensiveProducts(count)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).toEqual(MostExpensiveProducts);
                    return [2 /*return*/];
            }
        });
    }); });
    it('productsInOrders: should return products that exist in orders', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, DashboardQueriesObject.productsInOrders()];
                case 1:
