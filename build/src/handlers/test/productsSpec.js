...
describe('products endpoint responses', function () {
    ...
    it('getting products endpoint (Create)', function (done) {
        request
            .post("/products")
            .send({
            user_id: newUser.id,
    ...
    it('getting products endpoint (show)', function (done) {
        request
            .get("/products/".concat(newProduct.id))
            .end(function (_err, res) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, _b;
                return __generator(this, function (_c) {
    ...
    it('getting products endpoint (update)', function (done) {
        request
    ...
    it('getting products endpoint (delete)', function (done) {
        request
            .delete("/products/".concat(newProduct.id))
            .send({
            user_id: newUser.id,
        })
            .set({ Authorization: token_that_got_returned })
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(postRes.body).toEqual(jasmine.objectContaining({
                        id: newUser.id,
